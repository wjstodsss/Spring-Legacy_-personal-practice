...
<body>
    ...
    <div class="container">
        <form id="updateForm" action="/admin/inventory_insert" method="post">
            ...
            <button type="button" class="btn btn-info mb-2" onclick="window.location.href='secured/inventory_list'">List</button>
        </form>
